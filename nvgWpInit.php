...
<div style="width:49%; float: left;">
      ...
      <div class="postbox-container" style="width:99%;">
		...
		<img src="<?php echo plugins_url( 'contents/navegg-analytics.png', __FILE__ ); ?>" style="width: 240px; height: 40px; margin: 0 auto 20px auto;" />
...
?>
		...
		<form method="post" action="" onSubmit ="return validaFormSearch()" <?php echo $msgPost['class'] == 'updtSucess' ? 'styledisplay:none' : ''; ?> > 
			...
			<button class="button" style="float: left; margin-top: 6px; text-transform: uppercase;" title="<?php echo getTextNvg('nvgMsgAdmInitYourId_12'); ?>" >
        ...
        <div class="meta-box-sortables ui-sortable">
          <div class="postbox cnt_nvg" style="max-height: 315px;">
		   ...
		   <form method="post" action="" onSubmit ="return validaFormNew()" <?php echo $msgPost['class'] == 'updtSucess' ? 'styledisplay:none' : ''; ?> > 
			...
			<label for="stNvg" style="display: block; float: left; width: 80px; margin-right: 8px; padding-top: 7px; text-align: right;">
			...
			<label for="urNvg" style="display: block; float: left; width: 80px; margin-right: 8px; padding-top: 7px; text-align: right;">
			...
			<button class="button" style="float: left; margin-top: 6px; text-transform: uppercase;" title="<?php echo getTextNvg('nvgMsgAdmInitAccount_1'); ?>" >
